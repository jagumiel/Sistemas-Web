        ...
        <div class="wrapper">
            ...
            <div class="right-column">
				<div class="right-column-content">
					...
					<?php		
						/*	CUENTA DE PREGUNTAS - FALLA (189)
							$total_preguntas = makeQuery("SELECT COUNT(id) FROM pregunta");
							$num_rows = makeQuery("SELECT COUNT(id) FROM pregunta WHERE pregunta.email='{$email}'")[0];     	
	   
							echo $total_preguntas;
							echo $num_rows;
							//echo "<p>Has introducido ".$num_rows."/".$total_preguntas." de nuestra base de datos. Congrats y eso.</p>";	// Poner arriba modificando una etiqueta o algo
						*/	
						echo getUserPreguntas($email);											
					?>
